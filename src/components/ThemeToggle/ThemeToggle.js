...
const SunIcon = () => (
  <svg className="ThemeToggle_sun" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" aria-hidden="true">
...
const MoonIcon = () => (
  <svg className="ThemeToggle_moon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-hidden="true">
  ...
  return (
    <div className="ThemeToggle_container">
      <button
        type="button"
        role="switch"
        aria-checked={theme === "lightTheme"}
        className="button theme-toggler-button"
        onClick={toggleTheme}
        title="Toggle theme"
      >
